...
<head>
    ...
    <meta name="description" content="Freelancer Demo">
    <meta name="keywords" content="codiea,demo">
    <meta name="author" content="CODIEA">
    <title>Freelancer Demo</title>
    <link rel="apple-touch-icon" href="/assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="/codiea.png">
...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover"
            ...
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand"
                        href="../../../html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
                            <img src="/codiea.png" alt="">
                            {{-- <h2 class="brand-text mb-0">CODIEA</h2> --}}
                    </a></li>
            </ul>
        </div>
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="/assets/images/pages/eCommerce/1.png" alt="donuts" width="62">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="/assets/images/pages/eCommerce/7.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="/assets/images/pages/eCommerce/2.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="/assets/images/pages/eCommerce/3.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1"
                                    src="/assets/images/pages/eCommerce/5.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John
                                ...
                                class="round" src="/assets//images/portrait/small/avatar-s-11.jpg" alt="avatar"
    ...
    {{-- <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="/assets/images/portrait/small/avatar-s-8.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="/assets/images/portrait/small/avatar-s-1.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="/assets/images/portrait/small/avatar-s-14.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="/assets/images/portrait/small/avatar-s-6.jpg" alt="png"
                            height="32"></div>
                    <div class="search-data">
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item {{request()->segment(1) == "add-sales"?"active":""}}">
                        <a class="nav-link" href="/add-sales">
                            <i data-feather="plus"></i>
                            <span data-i18n="Add Sales">Add Sales</span>
                        </a> 
                    </li>
                </ul>
            </div>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2023<a
                    ...
                    target="_blank">CODIEA</a><span class="d-none d-sm-inline-block">, All rights
